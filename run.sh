...
then
    ./main -i ./instances/data/images/euro-night-0001000.instance -o output.txt -algorithm simulated_annealing -L 1000 -max -annealing local -algorithm2 incremental  -edgeselection 1 -initialization 1a
fi