...
then
    ./main -i ./instances/data/uniform/uniform-0000400-1.instance -o output.txt -algorithm simulated_annealing -L 1000 -min -annealing subdivision -algorithm2 convex_hull  -edgeselection 1  -m 100
fi