...
then
    ./main -i ./instances/data/images/euro-night-0000400.instance -o output.txt -algorithm simulated_annealing -L 1000 -min -annealing local -algorithm2 convex_hull -edgeselection 1 -m 100
fi